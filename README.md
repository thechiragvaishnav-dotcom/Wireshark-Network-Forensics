 ...
 - 3. Filtering HTTPs (secure) traffic
   ...
   - --> by typing <code>https</code> inside Filter bar
     ...
     - generally <code>port 80</code> for HTTPs.
       ...
       - this will show you all of the packets that where sent on TCP <code>port 80</code>, aka encrypted traffic.
...
## Page-4: Bird's eye view
   ...
   - because we have click on <code>Port A(column)/46481</code> the filter(Green line) include the port( <code>&& tcp.port==46481</code> )
